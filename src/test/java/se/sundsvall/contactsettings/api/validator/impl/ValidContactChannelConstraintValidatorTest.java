...
class ValidContactChannelConstraintValidatorTest {
	...
	private static Stream<Arguments> validContactChannelProvider() {
		return Stream.of(
			...
			Arguments.of(ContactChannel.create().withContactMethod(EMAIL).withDestination("hello@"), false),
			// Valid MSISDN:s.
			Arguments.of(ContactChannel.create().withContactMethod(SMS).withDestination("+46701740605"), true),
			...
			Arguments.of(ContactChannel.create().withContactMethod(SMS).withDestination("46701740605"), false),
