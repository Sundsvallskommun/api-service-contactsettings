...
INSERT INTO delegate_filter (delegate_id, `key`, value) VALUES
    ...
    ('7d5fbffc-d1ff-4fff-86de-8158b4e34459', 'facility-id', '123'),
    -- The "Mr blue -> Mr white"-delegate is filtered on contractId.
    ('336e4854-87f4-4407-9618-9fcf37e2f14f', 'contract-id', '456'),
    -- The "Mr white -> Mr Brown"-delegate is filtered on caseId.
    ('a1381b7f-9149-4fd5-a271-5513d9579a8d', 'case-id', '789');